<template>
<b-card @click.prevent="toggleItem($event,data.objectId)" :class="{'active' : selectedItems.includes(data.objectId)}" no-body>
    ...
    <b-card-body>
        <b-row>
            <b-colxx xxs="2">
                <b-form-checkbox :checked="selectedItems.includes(data.objectId)" class="itemCheck mb-0" />
            </b-colxx>
